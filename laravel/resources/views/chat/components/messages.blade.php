{{-- chat/components/messages.blade.php --}}
@foreach ($messages as $msg)
@if ($msg->senderID == auth()->id())
<div class="chat-content-rightside">
    <div class="d-flex ms-auto">
        <div class="flex-grow-1 me-2">
            <p class="mb-0 chat-time text-end">Sen, {{ optional($msg->created_at)->format('H:i') }}</p>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 ms-2">
            <p class="mb-0 chat-time">
                {{ $msg->sender->name }},
                {{ optional($msg->created_at)->format('H:i') ?? 'Zaman yok' }}
            </p>
