                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="ms-auto position-relative">
                                            ...
                                            <input type="password" name="password" class="form-control radius-30 ps-5" id="inputNewPassword" placeholder="Enter New Password" required>
                                            @error('password')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="ms-auto position-relative">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control radius-30 ps-5" id="inputConfirmPassword" placeholder="Confirm Password" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
