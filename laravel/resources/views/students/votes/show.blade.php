    ...
    <div class="container">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                @elseif($hasVoted && !$isVotingEnded)
                {{-- OY VERİLDİ AMA OYLAMA HENÜZ BİTMEDİ --}}
                <div class="alert alert-info mt-3">
                    <i class="bi bi-hourglass-split me-1"></i>
                    You have already voted. Please wait until the voting ends to see the results.
                </div>

                @elseif($hasVoted && $isVotingEnded)
                {{-- OY VERİLDİ VE OYLAMA BİTTİ -> SONUÇLAR --}}
