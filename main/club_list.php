...
<head>
  ...
  <title>EMU Club Management System | Active Clubs</title>
</head>
      ...
      <?php include "navbar.php"; ?>
       ...
       <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            <li>
              ...
              <ul>
                <li> <a href="#"><i class="bi bi-circle"></i>Blue Dashboard 1</a>
                </li>
            ...
            <li>
              <a class="has-arrow" href="javascript:;">
                ...
                <div class="menu-title">Club Lists</div>
              </a>
              <ul>
       ...
       <!--start content-->
          <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">Club Lists</div>
              <div class="ps-3">
       ...
       <footer class="footer">
        <div class="footer-text">
           Copyright © 2025.EMU All right reserved.
        </div>
        </footer>
        <!--end footer-->
